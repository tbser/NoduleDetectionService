...
from src.timeprofile import calltimeprofile, print_prof_data
...
@calltimeprofile
def make_pos_annotation_manual_images(source_dir, target_dir, clean_targetdir_first=False, only_patient_id=None):
    pass
